...
import { HowToPlayText, QuestionContainer, BackgroundImg, Line, QuestionTypeText, ErrorContainer, Error, ScrmabledWordText,SubmitBtn, Wrapper } from "./wordSrambleElement";
    ...
    return (
        <BackgroundImg img={img} >
            ...
            <QuestionContainer>
                ...
                <div>
                <ScrmabledWordText>{scrambledWord}</ScrmabledWordText>
                </div>
